    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.p
          ...
          className="mt-6 text-gray-400 text-sm sm:text-base max-w-md mx-auto leading-relaxed"
        >
        ...
        >
          ...
          <a
            ...
            className="px-8 py-3.5 rounded-full font-semibold text-white border border-white/20 hover:border-[#00e5ff]/50 hover:shadow-[0_0_20px_rgba(0,229,255,0.2)] transition-all duration-300 transform hover:scale-105"
          >
            Contactanos
          </a>
        </motion.div>
